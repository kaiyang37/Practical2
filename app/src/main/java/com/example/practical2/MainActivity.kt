...
//        binding.nicknameText.visibility = View.VISIBLE
        ...
        binding.apply {
            myName1?.nickname = nicknameEdit.text.toString() //If using var need to put '?'
            invalidateAll()
...
//        val editText: EditText = findViewById(R.id.nickname_edit)
//        val doneButton = findViewById<Button>(R.id.done_button) //One time findViewById, not multiple time
